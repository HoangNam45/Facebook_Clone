        ...
        <div className={cx('header_wrap')}>
            <div className={cx('header_search')}>
                <div className={cx('header_logo')}>
                    <svg viewBox="0 0 36 36" className={cx('header_logo_svg')}>
                        <path
                            className={cx('header_logo_svg_back')}
                        ...
                        ></path>
                        <path
                            className={cx('header_logo_svg_f')}
                ...
                <label className={cx('header_input_wrap')}>
                    <FontAwesomeIcon icon={faMagnifyingGlass} className={cx('header_input_search_icon')} />
                    <input type="text" placeholder="Tìm kiếm trên Facebook" className={cx('header_input')} />
                </label>
            </div>

            <div className={cx('header_option_wrap')}>
                <div className={cx('header_option')}>
                    <div className={cx('header_option_')}>
                        <svg viewBox="0 0 24 24" fill="currentColor" className={cx('header_option_svg')}>
            ...
            <div className={cx('header_user_wrap')}>
